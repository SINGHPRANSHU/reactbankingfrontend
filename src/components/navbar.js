...
return(
         ...
         <ul className={navbarClasses.join(" ")}>
            <li>
            <NavLink to="/"  exact={true} style={{display:"flex",flexDirection:"row",justifyContent:"space-between",alignItems:"center"}}><svg style={{color:"#08292e",marginRight:"0.4em",marginBottom:"0.4em"}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-credit-card-2-back-fill" viewBox="0 0 16 16">
